...
Let's investigate the estimated exposure-response function $h$, which quantifies the relationship between the exposures and the probit of the probability of an event ($Y = 1$). Here we plot the univariate  relationship h($z_m$), where all of the other exposures are fixed to their median values.
...
legend(-1, 5.5, c("BKMR", "oracle", "truth", "linear"), lwd = 2, col = c("black", "red", "blue", "orange"), lty = 1:4, y.intersp = 0.8)
