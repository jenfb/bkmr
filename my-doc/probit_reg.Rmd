...
$$
so that the probability of the event depends not just on $h$, but also on the particular values of the covariates ${\bf x}$. Thus, to estimate the association between $h$ and the probabiilty of the outcome, we must either fix the covariates or integrate over them. To integrate over the covariates, we estimate the probability of the outcome as
$$
P(Y = 1 \mid {\bf z})
